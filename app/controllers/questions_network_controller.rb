class QuestionsNetworkController < ApplicationController
  ...
  def index
    ...
    set_page_title(t("questions.index.title.bludgeon"))
    ...
    @questions = Question.paginate({:per_page => 3, :page => params[:page] || 1,
                                   :order => current_order,
